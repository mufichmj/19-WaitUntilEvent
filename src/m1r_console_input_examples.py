...
#      Write your line here:
#           x = float(input('how much money do you own?'))
...
#      Put your answer here:  The string part runs even if you put a number
# or nothing at all, but the question about age ends and errors.
#
